...
class crawled1551860600304 {
    up(queryRunner) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield queryRunner.query("CREATE TABLE `crawl_model_my_sql` (`id` int NOT NULL AUTO_INCREMENT, PRIMARY KEY (`id`)) ENGINE=InnoDB");
    ...
    down(queryRunner) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield queryRunner.query("DROP TABLE `crawl_model_my_sql`");
...
exports.crawled1551860600304 = crawled1551860600304;
//# sourceMappingURL=1551860600304-crawled.js.map